...
import { getSchoolConfigByKey, parseSchoolConfigResponseBody, SCHOOL_CONFIG_KEY } from "../../../services/SchoolFacilityService.jsx";
            ...
            >
                ...
                <DialogActions sx={{px: 3, py: 2.5, borderTop: "1px solid #e2e8f0", gap: 1, display: "flex", alignItems: "center"}}>
                    {(() => {
                        ...
                        const schoolQuota = Number(schoolAdmissionQuota) || 0;
                        const max = schoolQuota > 0 ? schoolQuota : totalConfiguredQuota;
